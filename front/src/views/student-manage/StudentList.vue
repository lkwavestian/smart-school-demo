                ...
                <template #default="scope">
                    <div style="display: flex; align-items: center; height: 55px">
                        <el-badge
                            ...
                            class="item"
                            :hidden="getBadge(scope.row) === 0"
                        >
                            <el-button round type="primary" @click="handleRate(scope.row)"
                                >评分</el-button
                            >
                        </el-badge>
                    </div>
        ...
        <el-drawer v-model="outerDrawer" direction="rtl" :size="size">
            ...
            <div>
                ...
                <el-alert type="info" show-icon>
                    请为<b style="font-size: 20px">{{ currentItem.studentname }}</b
                    >点亮成功之路的每一颗星星
                </el-alert>
                <el-divider></el-divider>
            ...
            >
                <StudentChart
                    :data="{ tableData, currentItem, tagData }"
                    v-if="innerDrawer"
                ></StudentChart>
            </el-drawer>
        </el-drawer>
