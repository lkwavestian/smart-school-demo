    ...
    <div id="home">
        <el-row :gutter="20" v-if="isCreated">
            <el-col :span="12" class="parent">
                <ClassAverageEchart :data="{studentsData,tagsData,classData}"></ClassAverageEchart>
            </el-col>
            <el-col :span="12" class="parent">
                <el-row :gutter="20">
                    <el-col :span="24" class="item">
                        <AverageEchart :data="{studentsData,tagsData,classData}"></AverageEchart>
                    </el-col>
                    <el-col :span="24" class="item">
                        <DangerStudent :data="{studentsData,tagsData,classData}"></DangerStudent>
                    </el-col>
